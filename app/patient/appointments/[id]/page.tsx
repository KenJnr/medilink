...
import { Calendar, Clock, User, MapPin, Phone, Mail, ArrowLeft, CreditCard, CheckCircle, XCircle, AlertCircle } from 'lucide-react'
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/patient/appointments" className="mt-4 inline-block text-blue-600 hover:underline">
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <Link href="/patient/appointments" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">
              ← Back
            </Link>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100">{doctor?.specialty || 'General Medicine'}</p>
                </div>
              </div>
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="border-t border-gray-200 pt-4">
              <h3 className="font-medium text-gray-900 mb-2">Doctor's Contact</h3>
