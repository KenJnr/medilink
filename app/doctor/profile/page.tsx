...
export default function DoctorProfilePage() {
  ...
  const removeQualification = (index: number) => {
    const newQualifications = profile.qualifications.filter((_, i) => i !== index)
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setProfile({ ...profile, specialty_id: e.target.value })}
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setProfile({ ...profile, consultation_type: e.target.value })}
                    className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors placeholder:text-gray-400 text-gray-900"
                  >
